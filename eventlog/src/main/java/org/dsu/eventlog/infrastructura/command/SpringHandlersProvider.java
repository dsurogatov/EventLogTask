...
// It's not my
// see https://github.com/BottegaIT/ddd-cqrs-sample
@Component
class SpringHandlersProvider implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public CommandHandler<Object, Object> getHandler(Object command) {
        ...
        if (beanName == null) {
            throw new RuntimeException("The command handler not found. Command class is " + command.getClass());
        }
